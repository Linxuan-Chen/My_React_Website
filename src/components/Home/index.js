 ...
 * @LastEditTime: 2020-09-29 17:48:55
    ...
    <>
      ...
      <div className={style.background}>
        <section className="container shadow-lg">
          ...
          <div className="row">
            <div className="col-4 text-center h5">HTML</div>
          ...
          <div className="row">
            <div className="col-4 text-center h5">CSS Sass Bootstrap</div>
            <div className="col-8 pt-1">
              <ProgressBar
                striped
                animated
          ...
          <div className="row">
            <div className="col-4 text-center h5">JavaScrip (ES6)</div>
            <div className="col-8 pt-1">
              <ProgressBar
                striped
                animated
